...
Transport experiment logs and generated plots are under:

```text
/home/qwu26/msquic_cellular/artifacts/bbr_logs/
```

CellNinjia parser runtime output is under:

```text
/home/qwu26/msquic_cellular/tools/cellninjia/test0/
```

The legacy `bbr_logs` path is kept as a local compatibility symlink to
`artifacts/bbr_logs`.

Generated data, plots, PDFs, build output, and run logs are intentionally ignored
by Git. The current full working-tree backup, including logs, was created at:

```text
/home/qwu26/msquic_backups/msquic_cellular_full_20260610_140244.tar
```
